...
c----------------------------------------------------------------------
      ...
      FUNCTION part_momi(xcom,ycom)  RESULT(momi)
...
c     Find the center of mass from the module subprogram.
      ...
      CALL part_com(xcm,ycm)
      WRITE(*,*) 'The center of mass is (',xcm,',',ycm,').'
      WRITE(*,*) 'The moment of interia is ',part_momi(xcm,ycm),'.'
